    ...
    <div class="container-fluid content-adjust" id="main-container">
      ...
      <div class="container-fluid mt-4 ml-3">
        ...
        <table class="table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th scope="col">Tên phát tuyến</th>
        ...
        <tr>
          ...
          <td>{{ $phatTuyen->ten_tuyen }} {{ $phatTuyen->donVi ? $phatTuyen->donVi->ten_don_vi : '' }}</td>
          <td>
          <div class="d-inline-block">
            <button type="button" class="btn btn-primary">
            <a href="{{ route('editTuyen', $phatTuyen->id) }}"
              style="color: white; text-decoration: none;">Sửa</a>
            </button>
          </div>
          <div class="d-inline-block">
            <form action="{{ route('deleteTuyen', $phatTuyen->id) }}" method="POST"
            onsubmit="return confirm('Bạn có chắc chắn muốn xóa đội này?');" style="display: inline;">
            @csrf
            @method('DELETE')
          ...
          <div class="d-inline-block">
                    <button type="button" class="btn btn-secondary">
                        <a href="{{ route('showDuongDayTheoTuyen', $phatTuyen->id) }}" style="color: white; text-decoration: none;">Đường dây</a>
                    </button>
                </div>
          </td>
