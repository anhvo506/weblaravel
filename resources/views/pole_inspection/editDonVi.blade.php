  ...
  <nav class="navbar bg-body-tertiary fixed-top">
    <div class="container-fluid content-adjust" id="main-container">
      ...
      <div class="container-fluid mt-4 ml-3">
        ...
        <form action="{{ route('updateDonVi', $donVi->id) }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="ma_don_vi" class="form-label">Mã đơn vị</label>
                <input type="text" name="ma_don_vi" class="form-control" id="ma_don_vi" value="{{ $donVi->ma_don_vi }}" required>
            </div>
            <div class="mb-3">
                <label for="ma_vung" class="form-label">Mã vùng</label>
                <input type="text" name="ma_vung" class="form-control" id="ma_vung" value="{{ $donVi->ma_vung }}" required>
            </div>
            <div class="mb-3">
                <label for="ten_don_vi" class="form-label">Tên đơn vị</label>
                <input type="text" name="ten_don_vi" class="form-control" id="ten_don_vi" value="{{ $donVi->ten_don_vi }}" required>
            </div>
            <div class="mb-3">
                <label for="ten_tat" class="form-label">Tên tắt</label>
                <input type="text" name="ten_tat" class="form-control" id="ten_tat" value="{{ $donVi->ten_tat }}" required>
            </div>
