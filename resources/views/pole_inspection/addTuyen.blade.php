  ...
  <nav class="navbar bg-body-tertiary fixed-top">
    <div class="container-fluid content-adjust" id="main-container">
      ...
      <div class="container-fluid mt-4 ml-3">
            <form action="{{ route('createTuyen') }}" method="POST" id="update_user">
            @csrf
            <div class="new_user">
              
                <div class="mb-3">
                    <label for="ten_tuyen" class="form-label">Tên Tuyến</label>
                    <input type="text" name="ten_tuyen" class="form-control" placeholder="Nhập tên tuyến" required>
                </div>
                <div class="mb-3">
                    <label for="don_vi_id" class="form-label">Đơn Vị</label>
                    <select name="don_vi_id" class="form-select" id="don_vi_id" required>
