...
<body>
  <nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="bo_phan" name="bo_phan" required>
    </div>
    <div class="mb-3">
        <label for="chuc_danh" class="form-label">Chức danh</label>
        <input type="text" class="form-control" id="chuc_danh" name="chuc_danh" required>
    </div>
    <div class="mb-3">
        <label for="bac_tho" class="form-label">Bậc thợ</label>
        <input type="text" class="form-control" id="bac_tho" name="bac_tho" required>
    </div>
    <div class="mb-3">
        <label for="bac_AT" class="form-label">Bậc AT</label>
        <input type="text" class="form-control" id="bac_AT" name="bac_AT" required>
    </div>
    <div class="mb-3">
        <label for="permissions" class="form-label">Quyền</label>
        <select class="form-select form-select-sm form_select"  id="permissions" name="permissions[]">
