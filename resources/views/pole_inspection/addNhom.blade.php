  ...
  <nav class="navbar bg-body-tertiary fixed-top">
    <div class="container-fluid content-adjust" id="main-container">
      ...
      <div class="container-fluid mt-4 ml-3">
        <form action="{{ route('createNhom') }}" method="POST">
          @csrf
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="thu_tu_nhom" name="thu_tu_nhom">
          </div>
          <div class="mb-3">
            <label for="id_nhan_vien" class="form-label">Chọn Nhân Viên</label>
            <div class="form-check">
              @foreach($nhanViens as $nhanVien)
          <input type="checkbox" class="form-check-input" id="nhanvien{{ $nhanVien->id }}" name="id_nhan_vien[]"
          value="{{ $nhanVien->id }}">
